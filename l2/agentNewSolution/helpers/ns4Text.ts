...
export const NS4_PHRASES = {
  ...
  'actor.drop.question': 'Actor {actor} was inferred and has no exclusive step. Drop it?',
  'actor.drop.changeHint': 'An inferred external actor whose steps another actor already performs is a persona, not an access role.',
  'actor.keep.question': 'Actor {actor} was inferred and has exclusive steps. Keep it?',
  'actor.keep.changeHint': 'The model invented this actor; exclusive steps are the reason it remains.',
  'actor.system.question': 'Actor {actor} is a system integration point, not a persona. Keep it?',
  'actor.system.changeHint': 'A kind:system actor is an inbound integration, not a demographic persona.',
