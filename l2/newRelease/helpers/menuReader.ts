...
export function menuFileForProject(project: number, moduleName: string, root?: string): Ns5FileInfo {
  return {
    project,
    level: 4,
...
export async function readModuleMenu(project: number, moduleName: string, root?: string): Promise<MenuReadResult> {
